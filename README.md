...
The `code/` folder contains the source code and a README.md file that contains the instructions for installing the tool from source. 

The `artifacts/` folder contains the following files.
 ...
 - `all-cards.xlsx` - Data containing the evaluation of several existing model cards which was used to develop the rubric.
  - `User-Study/Advertisement.pdf` -  Advertisement for recruting participants for the user study.
